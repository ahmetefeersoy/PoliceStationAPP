 ...
 * @author efe
 */
public class UpdateScreenForCriminal extends javax.swing.JFrame {

    /**
     * Creates new form UpdateScreenForCriminal
     */
    public UpdateScreenForCriminal() {
        initComponents();
    }
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtFINDID, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
         ...
         int r = JOptionPane.showConfirmDialog(this,"Are you sure to update this criminal!!");
         if(r==0){
               Boolean b= st.execute("UPDATE criminal set criminal_id = '" + txtID1.getText()+ "',birth_data='"+txtBD.getText()+"',blood_type='"+txtBT1.getText()+"', gender ='"+txtGENDER1.getText()+"',SSN='"+txtSSN1.getText()+"',Lname='"+txtLNAME1.getText()+"',Fname='"+txtFNAME1.getText()+"'where criminal_id='"+txtFINDID.getText()+"' ");
    ...
    ResultSet rs =  st.executeQuery("select criminal_id,Lname,Fname,Birth_data,Blood_Type,Gender,SSN from criminal where criminal_id='" +txtFINDID.getText()+"' ");
while(rs.next()){
  txtID1.setText(rs.getString("criminal_id"));
  txtLNAME1.setText(rs.getString("Lname"));
  txtFNAME1.setText(rs.getString("Fname"));
  txtBD.setText(rs.getString("Birth_Data"));
  txtBT1.setText(rs.getString("Blood_Type"));
  txtGENDER1.setText(rs.getString("Gender"));
  txtSSN1.setText(rs.getString("SSN"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateScreenForCriminal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateScreenForCriminal().setVisible(true);
            }
        });
    }
